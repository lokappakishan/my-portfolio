export const projects = [
  ...
  },
  {
    ...
    description: "A stand-alone webpage built using HTML, CSS and Javascript for a product. Uses flexbox and Grid to make the web page adaptive for desktop and mobile displays.",
      image: '/images/flyo.png',
      tags: ['HTML', 'CSS', 'Javascript'],
  ...
  },
  {
    ...
    description: "The project utilizes frequency and time to construct an acoustic viewer. The viewer has a rainbow bar chart on the bottom that shows the frequencies. The yellow line represents the time data for the arriving audio. We simply paint those two things to canvas using javascript.",
    image: '/images/AudioVisualizer.jpeg',
    tags: ['HTML', 'CSS', 'Javascript'],
    source: 'https://github.com/lokappakishan/acoustic-visualizer',
    visit: 'https://github.com/lokappakishan/acoustic-visualizer',
    id: 3,
  },
];
...
export const TimeLineData = [
  ...
  { year: 2020, text: 'Worked as Frontend Developer at TrafficNow', },
